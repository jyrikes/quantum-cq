...
class PipelineBuilderProtocol(Protocol):
    ...
    def with_circuit(self, circuit: Any) -> "PipelineBuilderProtocol": ...

    def with_engine(self, engine: str) -> "PipelineBuilderProtocol": ...

    def with_target(self, target: Any, *, snapshot: Any = None) -> "PipelineBuilderProtocol": ...

    def transpile(self) -> Any: ...

    def compile(self, *, engine: str | None = None, **options: Any) -> Any: ...

    def run_engine(self, *, engine: str | None = None, shots: int | None = None, **options: Any) -> Any: ...
